...
def main():
    ...
    """
    # Folder paths
    jd_folder = "./Job_description"  # Folder containing job descriptions
    resumes_folder = "./Resumes"      # Folder containing resumes in PDF format

    # Output files
    jd_output_file = "jd_key_aspects.json/Job_description_key_aspects.json"  # JSON file for job description key aspects
    resumes_output_file = "ranked_resumes.json"  # Output file for ranked resumes

    # Step 1: Process job descriptions
    process_jd_folder(jd_folder, jd_output_file)
    print(jd_output_file)
